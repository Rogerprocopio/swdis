...
echo.
if %_AUR% EQU 1 (           
call :Cfgbg %_cWht% "               [2] Ativar Windows e Office com Renovacao Automatica " %_cGrn% "[%_dHook%]"
) else (
echo                [2] Ativar Windows e Office com Renovacao Automatica
)
echo.
echo.
echo.
...
choice /c 1234567890ERSX /n /m ">           Escolha uma opcao do menu ou pressione 0 para sair: "
set _el=%errorlevel%
